...
Feature: The simple process is routed correctly
  Background:
    ...
    Given the process 'processes/simple_process.bpmn20.xml' is deployed as 'simple_process'
  #  Given the process 'processes/message_process.bpmn20.xml' is deployed
    Given the form 'forms/firstForm.form' is deployed

  Scenario: The country 'es' was selected in the first form
    When the process 'simple_process' is started by 'admin'
